...
~/STY8/Cmds_for_running_R_scripts/Cmds_Single-species_simulations/Cmds_for_Rscript_BacArena_SingleSpecies__simuDiet_optparse_pFBA_ka.sh
...
~/STY8/Cmds_for_running_R_scripts/Cmds_2-species_network/Cmds_for_Rscript_BacArena_otu6n8__simuDiet_optparse_FBA_ka.sh
...
~/STY8/Cmds_for_running_R_scripts/Cmds_3-species_network/Cmds_for_Rscript_BacArena_otu2n6n8__simuDiet_optparse_FBA_ka.sh
...
~/STY8/Cmds_for_running_R_scripts/Cmds_8-species_network/Cmds_for_Rscript_BacArena_8species__simuDiet_optparse_pFBA_ka.sh
